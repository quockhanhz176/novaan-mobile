...
export const SIGN_IN_SIGN_IN_BUTTON_TITLE = "Đăng nhập";
export const SIGN_IN_FORGET_PASSWORD = "Quên mật khẩu?";
...
export const SIGN_IN_GOOGLE_ERROR_OCCURED =
    "Đăng nhập với tài khoản Google không thành công, xin vui lòng thử lại sau";

// Sign up screen
export const SIGN_UP_SUCCESS_TITLE = "Đăng ký tài khoản thành công";
...
export const SIGN_UP_REENTER_PASSWORD_PLACEHOLDER = "Nhập lại mật khẩu của bạn";
...
// Create post screen
export const CREATE_POST_UPLOAD_TITLE = "Đăng tải";
export const CREATE_POST_UPLOAD_RECIPE_TITLE = "Đăng công thức nấu ăn";
